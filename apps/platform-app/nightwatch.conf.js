const BUILD_NUMBER = import.meta.TRAVIS_JOB_NUMBER || 'local';
...
let nightwatch_config = {
  ...
  common_capabilities: {
    ...
    'browserstack.user': import.meta.BROWSERSTACK_USERNAME,
    'browserstack.key': import.meta.BROWSERSTACK_ACCESS_KEY,
