...
export function filterPageCredibleSet(data, credSet95Value) {
    ...
    return (
        data.map(flattenPosition)
        .filter((d) => credSet95Value === '95' ? d.is95CredibleSet : true)
    );
}

export function buildCredibleGwasColocalisation(gwasColocalisationFiltered, data, credSet95Value) {
...
export function buildCredibleQtlColocalisation(qtlColocalisationFiltered, data, credSet95Value) {
    return (
