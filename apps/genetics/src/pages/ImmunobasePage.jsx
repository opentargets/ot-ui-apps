...
const ImmunobasePage = ({ classes }) => (
  <BasePage>
    <Grid className={classes.information} container justifyContent="center" alignItems="center">
      <Grid item xs={12} sm={10} md={6}>
        <Typography align="center">
          ...
          <p>
            Results for all publicly available GWAS, including ImmunoBase studies, can be explored
            using <Link to="/">Open Targets Genetics</Link>. You can search by{" "}
            <Link to="/study/GCST005536">study</Link>,{" "}
            <Link to="/variant/2_203874196_G_A">variant</Link> or{" "}
            <Link to="/gene/ENSG00000162594">gene</Link> to find trait-associated loci and
            prioritise genes using our{" "}
            <Link external to="https://genetics-docs.opentargets.org/our-approach/data-pipeline">
              variant-to-gene
            </Link>{" "}
            and{" "}
            <Link
          ...
          <p>
            Summary statistics and curated data previously hosted by ImmunoBase can now be
            downloaded from the{" "}
