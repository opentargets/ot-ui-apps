...
function Dag({ ensemblId, width, height, links, nodes, xOffset, textLimit, svgRef }) {
    ...
    >
      ...
      <g transform="translate(0, 10)">
        <rect
          ...
          strokeWidth="2"
        />
        <text x="16" y="4" fill="#5a5f5f" dominantBaseline="middle" fontSize="12">
          therapeutic area
        </text>
        <circle cx="6" cy="20" r={radius} fill="none" stroke="#e0e0e0" strokeWidth="2" />
        <text fill="#5a5f5f" x="16" y="20" dominantBaseline="middle" fontSize="12">
          disease
        </text>
      </g>
      ...
      <g transform={`translate(0, ${yOffset})`}>
        {nodes.map(node => (
          <Fragment key={node.id}>
            <text x={node.y - xOffset} y={node.x} dx="6" fontSize="12" dominantBaseline="middle">
