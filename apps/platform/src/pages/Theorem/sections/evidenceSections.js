...
const evidenceSections = new Map([
  ...
  [
    'cancer_biomarkers',
    lazy(() => import('sections/src/evidence/CancerBiomarkers/Body')),
  ],
  [
    'cancer_gene_census',
    lazy(() => import('sections/src/evidence/CancerGeneCensus/Body')),
  ],
  [
    'crispr_screen',
    lazy(() => import('sections/src/evidence/CRISPRScreen/Body')),
  ],
  [
    'expression_atlas',
    lazy(() => import('sections/src/evidence/ExpressionAtlas/Body')),
  ],
  [
    'gene2phenotype',
    lazy(() => import('sections/src/evidence/Gene2Phenotype/Body')),
  ],
  [
    'genomics_england',
    lazy(() => import('sections/src/evidence/GenomicsEngland/Body')),
  ],
  [
    'ot_genetics_portal',
    lazy(() => import('sections/src/evidence/OTGenetics/Body')),
  ],
  [
    'ot_crispr_validation',
    lazy(() => import('sections/src/evidence/OTValidation/Body')),
  ],
  [
    'uniprot_literature',
    lazy(() => import('sections/src/evidence/UniProtLiterature/Body')),
  ],
  [
    'uniprot_variants',
    lazy(() => import('sections/src/evidence/UniProtVariants/Body')),
  ],
]);
