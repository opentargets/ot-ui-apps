import { summaryUtils } from 'ui';
import { Drug, Widget } from 'sections';
import { gql } from '@apollo/client';
import ProfileHeader from "./ProfileHeader";

// This is the order of the widgets in the profile page
export const drugProfileWidgets = new Map<string, Widget>([
...
const DRUG_PROFILE_SUMMARY_FRAGMENT = summaryUtils.createSummaryFragment(drugProfileWidgetsSummaries, "Drug");
