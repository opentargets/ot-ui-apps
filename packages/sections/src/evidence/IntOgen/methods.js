const methods = {
  ...
  hotmaps: {
    id: "HotMAPS",
    description: "Somatic mutations in the gene are significantly clustered according to HotMAPS",
  },
  oncodriveclustl: {
    id: "ClustL",
    description:
  ...
  smregions: {
    id: "smRegions",
    description: "Somatic mutations in the gene are significantly clustered according to smRegions",
  },
  cbase: {
    id: "CBaSE",
    description: "Genes more mutated than the background neutral mutation rate according to CBaSE",
  },
  dndscv: {
    id: "dNdScv",
    description: "Genes more mutated than the background neutral mutation rate according to dNdScv",
  },
  oncodrivefml: {
    id: "FML",
    description:
