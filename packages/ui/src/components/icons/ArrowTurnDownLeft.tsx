...
<svg id="Layer_2"
    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 443.18 334.88" className={classes.mainIcon}>
    <defs>
        <style>{".cls-1{fill:none;stroke:#1f5279;stroke-linecap:round;stroke-miterlimit:10;stroke-width:43px;}"}</style>
    </defs>
    <g id="Layer_2-2">
